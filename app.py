...
# ---------------------------------------------------------
    ...
    with c_prof2:
        st.write(
            "・**専門:**"
            " 次世代半導体材料・アグリフォトニクス（LED農工学）\n・**略歴:**"
            " 東京帝国工業大学卒業、MIT客員研究員、目立製作所中央研究所主任研究員を経て現職。\n・**研究業績:**"
            " 「青色LEDを活用した藍発酵プロセスの高速化」で国際学会賞を受賞。\n・**特技・趣味:**"
            " 徳島ラーメンの食べ歩き（通算2,000杯以上）、阿波踊り（男踊り）"
        )
