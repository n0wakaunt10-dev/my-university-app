...
# ※校章画像ができるまではコメントアウト（あるいは別の簡易ロゴ画像を設置）しています。
# 校章URLが決まったら下の行のコメント(#)を解除してください。
# st.sidebar.image("https://i.ibb.co/xxxxx/logo.jpg", caption="校章：歯車と藍の葉", use_container_width=True)
